...
static const char colors[NUMCOLORS][ColLast][9] = {
	...
	{ "#282a2e", "#676d75", "#1d1f21" },	// 1 = normal (grey on black)
...
static const char *dmenucmd[] = { "dmenu_run", "-b", "-fn", "xft:terminus:size=10:antialias=true", "-nb", colors[0][ColBG], "-nf", colors[0][ColFG], "-sb", colors[1][ColBG], "-sf", colors[1][ColFG], NULL };
